...
<div class="col-md-12">
    ...
    <div class="card card-primary">
      ...
      <!-- /.card-header -->
      <!-- form start -->
      <form action="{{ route('dosen.update-foto', $dosen->id) }}"  enctype="multipart/form-data" method="post">
        @csrf
        <div class="card-body">
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="nama_dosen" class="form-control" value="{{ $dosen->nama_dosen }}" readonly>
                    </div>
                    <div class="form-group">
                ...
                <div class="col-md-6">
                    <img src="{{ asset($dosen->foto) }}" class="img img-responsive" alt="" width="30%" />
                </div>
            </div>
        </div>
        <!-- /.card-body -->
